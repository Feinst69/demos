...
# Assurez-vous que `final_df` contient les données de vos départements et du taux d'abstention
...
# Créer un graphique en barres pour visualiser le taux de pauvreté
ggplot(combined_df, aes(x = reorder(Department, txabs), y = txcho, fill = group)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Taux de chomage dans les départements \n avec le plus fort et plus faible taux d'abstention",
       x = "Départements",
       y = "Taux de chomage (%)") +
  coord_flip() +  # Inverser les axes pour une meilleure lisibilité
  theme_minimal() +
...
```{r}
# Créer un graphique en barres pour visualiser le taux de pauvreté
ggplot(combined_df, aes(x = reorder(Department, txabs), y = Cadres, fill = group)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Pourcentage de cadres dans les départements \n avec le plus fort et plus faible taux d'abstention",
       x = "Départements",
       y = "Cadres (%)") +
  coord_flip() +  # Inverser les axes pour une meilleure lisibilité
  theme_minimal() +
...
```{r}
# Créer un graphique en barres pour visualiser le taux de pauvreté
ggplot(combined_df, aes(x = reorder(Department, txabs), y = NonDiplome, fill = group)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Poucentage de non diplomés dans les départements \n avec le plus fort et plus faible taux d'abstention",
       x = "Départements",
       y = "Non dipomé (%)") +
  coord_flip() +  # Inverser les axes pour une meilleure lisibilité
  theme_minimal() +
...
```{r}
# Créer un graphique en barres pour visualiser le taux de pauvreté
ggplot(combined_df, aes(x = reorder(Department, txabs), y = Agri, fill = group)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Pourcentage d'agriculteurs dans les départements \n avec le plus fort et plus faible taux d'abstention",
       x = "Départements",
       y = "Agriculteurs (%)") +
  coord_flip() +  # Inverser les axes pour une meilleure lisibilité
  theme_minimal() +
...
```{r}
# Créer un graphique en barres pour visualiser le taux de pauvreté
ggplot(combined_df, aes(x = reorder(Department, txabs), y = Ouvrier, fill = group)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Pourcentage d'ouvriers dans les départements \n avec le plus fort et plus faible taux d'abstention",
       x = "Départements",
       y = "Ouvriers (%)") +
  coord_flip() +  # Inverser les axes pour une meilleure lisibilité
  theme_minimal() +
...
```{r}
# Créer un graphique en barres pour visualiser le taux de pauvreté
ggplot(combined_df, aes(x = reorder(Department, txabs), y = Artisant, fill = group)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Pourcentage d'artisants dans les départements \n avec le plus fort et plus faible taux d'abstention",
       x = "Départements",
       y = "Artisant (%)") +
  coord_flip() +  # Inverser les axes pour une meilleure lisibilité
  theme_minimal() +
...
```{r}
# Créer un graphique en barres pour visualiser le taux de pauvreté
ggplot(combined_df, aes(x = reorder(Department, txabs), y = Salairemoy, fill = group)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Salaire moyen dans les départements \n avec le plus fort et plus faible taux d'abstention",
       x = "Départements",
       y = "Salaire moyen") +
  coord_flip() +  # Inverser les axes pour une meilleure lisibilité
  theme_minimal() +
...
L'analyse révèle que les départements présentant des taux élevés d'abstention sont souvent marqués par des niveaux de pauvreté et de chômage élevés et, une forte présence de logements sociaux. À l'inverse, les départements avec un taux d'abstention faible se caractérisent par une meilleure situation socio-économique. Ce constat suggère que des inégalités socio-économiques exacerbées pourraient être à l'origine de la désillusion politique et de la déconnexion vis-à-vis du processus électoral dans ces régions. Pour améliorer la participation électorale, il est recommandé de renforcer l'éducation civique, de simplifier les démarches de vote (ex. vote électronique, vote anticipé), d'améliorer les services publics dans les zones défavorisées, de promouvoir des politiques inclusives et de soutenir une plus grande diversité de candidats. Des campagnes de mobilisation locale, en collaboration avec des leaders communautaires, pourraient également renforcer l'engagement des citoyens dans les zones à forte abstention.
